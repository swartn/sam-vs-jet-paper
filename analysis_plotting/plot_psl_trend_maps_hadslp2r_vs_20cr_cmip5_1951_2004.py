...
def plot_trend_maps(datapath):
    ...
    # Marshall locations
    marshlat = np.array([46.9, 37.8, 42.9, 43.5, 39.6, 40.4, 70.8, 67.6, 66.6, 
                         66.3, 66.7, 65.2])*-1
    marshlon = np.array([37.9, 77.5, 147.3, 172.6, 360-73.1, 360-9.9, 11.8, 62.9, 
                         93.0, 110.5, 140.0, 360-64.3])

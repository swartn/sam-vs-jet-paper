""" Compute trends in the tauu fields of the CMIP5 models and save them in a
...
path ='/raid/ra40/data/ncs/cmip5/sam/c5_tauu/'
filepattern = 'tauu_Amon_*r1i1p1*'
...
#ens_remap = cd.mkensemble('remap_tauu*', prefix='remap_')

# Do trends over 1988 to 2011
# compute trends and load into np structure
ens1 = cd.trends(ens_remap, start_date='1988-01-01', 
...
slopes = cd.loadfiles(ens1, 'tauu')

# save np structure, with a list of models in HDF5
h5f = h5py.File('/raid/ra40/data/ncs/cmip5/sam/cmip5_trends.h5', 'a')
h5f.create_dataset('tauu/1988_2011/c5_tauu_trend_1988_2011', data=slopes)
model_names = [ model.name for model in ens_remap.models]
h5f.create_dataset('tauu/1988_2011/model_names', data=model_names)
h5f.close()


##read it back in
#h5f = h5py.File('/raid/ra40/data/ncs/cmip5/sam/cmip5_trends.h5','r')
#slopes2 = h5f['tauu/1988_2011/c5_tauu_trend_1988_2011'][:]
#names2 = h5f['tauu/1988_2011/model_names'][:]
#h5f.close()

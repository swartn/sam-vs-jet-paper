""" Compute trends in the psl fields of the CMIP5 models and save them in a
...
h5f.create_dataset('psl/1951_2004/c5_psl_trend_1951_2004', data=slopes)
model_names = [ model.name for model in ens.models]
h5f.create_dataset('psl/1951_2004/model_names', data=model_names)
h5f.close()

#read it back in
#h5f = h5py.File('cmip5_trends.h5','a')
#slopes2 = h5f['c5_psl_trend_1951_2004'][:]

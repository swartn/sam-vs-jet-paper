...
# compute trends and load into np structure
ens_remap = cd.mkensemble('remap_uas*', prefix='remap_')
ens2 = cd.trends(ens_remap, start_date='1988-01-01', 
                end_date='2011-12-31', delete=False)
...
slopes2 = cd.loadfiles(ens2, 'uas')

# save np structure, with a list of models in HDF5
h5f = h5py.File('cmip5_trends.h5', 'a')
h5f.create_dataset('uas/1988_2011/c5_uas_trend_1988_2011', data=slopes2)
model_names = [ model.name for model in ens_remap.models]
h5f.create_dataset('uas/1988_2011/model_names', data=model_names)
h5f.close()

##read it back in
#h5f = h5py.File('cmip5_trends.h5','r')
#slopes2 = h5f['uas/1988_2011/c5_uas_trend_1988_2011'][:]
